<template>
  <div id="app" class="container mx-auto p-6">
    ...
    <div class="flex flex-col md:flex-row mb-4">
      ...
      />
      <button
        @click="searchProformas"
        class="p-2 text-white rounded-r-md md:rounded-l-none"
        style="background-color: #0c3f81"
      >
        Buscar
      </button>
    </div>
    ...
    <div class="flex justify-center m-5">
      <button
        @click="fetchProformas(prevPage)"
        :disabled="!prevPage"
        class="p-2 bg-gray-300 text-gray-700 rounded-md mx-2"
      >
        Anterior
      </button>
      <button
        @click="fetchProformas(nextPage)"
        :disabled="!nextPage"
        class="p-2 bg-gray-300 text-gray-700 rounded-md mx-2"
      >
        Siguiente
...
export default {
  ...
  methods: {
    imprimirProforma(proformaId) {
      api
        .get(`api/imprimir-proforma/${proformaId}/`, {
          headers: {
