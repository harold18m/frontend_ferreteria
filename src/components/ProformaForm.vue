          ...
          <tr>
            ...
            <td>
              <input
                ...
                v-model="direccion"
                :class="{ 'input-con-valor': direccion }"
                id="direccion"
                name="direccion"
                class="input-field"
              />
      ...
      <table class="w-full table-auto">
        <thead>
          <tr>
            ...
            <th class="table-header-1 precio_unitario">
              <div class="theader">P. Unit (S/)</div>
            </th>
            <th class="table-header-1 importe">
              <div class="theader">Importe</div>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(item, index) in proformaItems" :key="index">
            <td>
              <input
                ...
                :class="{ 'input-con-valor': item.cantidad }"
                name="cantidad"
                min="0"
                class="input-field"
            ...
            <td>
              <input
                ...
                :class="{ 'input-con-valor': item.descripcion }"
                name="descripcion"
                class="input-field"
                @keydown.enter.prevent
              />
            ...
            <td>
              <input
                ...
                :class="{ 'input-con-valor': item.precio_unitario }"
            ...
            <td>
              <button @click.prevent="eliminarFila(index)" class="delete-btn">
...
export default {
  ...
  methods: {
    ...
    recalcularImporteTotal() {
      try {
        this.importeTotal = this.proformaItems
          .reduce((total, item) => {
    ...
    submitForm() {
      ...
      api
        .post('api/crear-proforma/', dataToSend)
        .then((response) => {
        ...
        .catch((error) => {
          if (error.response && error.response.data) {
            ...
            Swal.fire('Error', 'Ocurrió un error al crear la proforma', 'error')
          }
        })
    },
  },
